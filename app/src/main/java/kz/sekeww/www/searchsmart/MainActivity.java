package kz.sekeww.www.searchsmart;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] strDiscrArrData;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (searchView != null) {
            ...
            searchView.setQueryHint("Что вам приснилось?");
            ...
            searchView.setOnSuggestionListener(new SearchView.OnSuggestionListener() {
                ...
                public boolean onSuggestionClick(int position) {
                   ...
                   // Log.d("myTag", );
                    //textView.setText(strDiscrArrData[cursor.getInt(position)]);
                    // Check if no view has focus:
                    View view = MainActivity.this.getCurrentFocus();
                    if (view != null) {
                        InputMethodManager imm = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
                        imm.hideSoftInputFromWindow(view.getWindowToken(), 0); //hides Keyboard
                    }
                    return true;
                }
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://gregarious.kz/index.php/main/get_json_horoscope");
        ...
        protected void onPostExecute(String result) {
            ...
            ArrayList<String> dataDiscrList = new ArrayList<String>();
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        dataDiscrList.add(json_data.getString("today"));
                    }

                    strArrData = dataList.toArray(new String[dataList.size()]);
                    strDiscrArrData = dataDiscrList.toArray(new String[dataDiscrList.size()]);
